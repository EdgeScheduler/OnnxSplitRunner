...
def StartProcess(model_name:str,input_queue:Queue,run_signal: Pipe,done_signal: Pipe, test_ok:Pipe,output_queue:Queue,model_dict:dict,input_shapes:dict,default_batchsize=15):
    '''
